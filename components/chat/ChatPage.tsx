...
// ✅ Instruction initiale pour guider Mistral (ne sera pas affichée)
const initialInstruction: Message = {
  role: "user",
  content:
    "Tu t'appelles Chatrohy. Sois clair, précis et utile.",
}
...
export default function ChatPage() {
  ...
  const sendMessage = async () => {
    ...
    const visibleMessages = [...messages, userMessage] // Messages affichés
    const messagesToSend = [initialInstruction, ...visibleMessages] // Pour Mistral
    ...
    try {
      ...
      if (!data.result) {
        ...
        setMessages([...visibleMessages, { role: "assistant", content: data.result }])
      }
    } catch (err) {
  ...
  return (
    <div className="w-full h-screen relative flex flex-col font-outfit">
      {/* Header */}
      ...
      {/* Messages */}
      <ScrollArea className="flex-1 px-4 py-2 space-y-2 overflow-y-auto overflow-hidden">
