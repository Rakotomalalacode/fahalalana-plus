...
//     DialogTrigger,
// } from "@/components/ui/dialog"
// import { AlertCircleIcon, ImageUpIcon, PaperclipIcon, UploadIcon, XIcon } from "lucide-react"
...
//                 <DialogContent className="sm:min-w-[800px] flex flex-col items-center rounded">
//                     <DrawerHeader>
//                         <DrawerTitle className="outfit text-center">Crée un nouvelle cours</DrawerTitle>
//                         <DrawerDescription className="outfit -ml-4">
...
//         formData.append("title", title);
//         formData.append("description", description);
//         if (video) formData.append("video", video as File);
//         if (thumbnail) formData.append("thumbnail", files[0].file as File);
...
//         if (res.ok) {
//             toast(<div className="text-green-700 font-outfit text-sm flex gap-2 items-center"><IconCircleDashedCheck /> cours ajouté avec success !</div>)
//             setTitle("");
//             setDescription("");
//             setVideo(null);
//             setThumbnail(null);
...
//     return (
//         <form onSubmit={handleSubmit} className="w-full font-outfit space-y-6">
...
//                    </div>
//                     <div className="grid gap-3">
//                         <Label htmlFor="video">Video du cours</Label>
//                         <Input
//                         type="file"
//                         accept="video/*"
//                         onChange={(e) => setVideo(e.target.files?.[0] || null)}
