...
export default function OneCours() {
    ...
    return (
        <div className="relative w-full font-outfit lg:h-[520px] z-0">
            <div className="relative w-full lg:h-[520px] overflow-hidden rounded-lg">
                <video
                    ref={videoRef}
            ...
            <div className="w-full lg:absolute relative bottom-0 gadient-videos border-b-1 rounded-b-lg">
...
//     return (
//         <div className="relative w-full font-outfit lg:h-[500px] z-0 rounded-lg">
...
//                 playsInline
//             >
//                 <source src="/images/ZAKAI - MELODIE  (Clip officiel).webm" type="video/mp4" />
//                 Votre navigateur ne supporte pas la vidéo.
//             </video>

//             <div className="absolute backdrop-blur-sm w-full top-0 pt-6 h-[99.9%] rounded-b-lg lg:h-[97%] flex items-start px-4 lg:px-10 rounded-t-lg">
//                 <div className="text-white max-w-md                                                       ">
//                     <h1 className="text-xl w-[80%] lg:w-full lg:text-5xl font-bold mb-4">
//                         Formation Apprendre Tailwind CSS v4 en 2025
//                     </h1>
//                     <p className="text-sm hidden lg:block lg:text-base mb-6">
//                         Dominez Tailwind CSS version 4 : apprenez à concevoir des interfaces réactives,
//                         claires ou sombres, en un temps record et devenez expert front-end en 2025.
//                     </p>
//                     <p className="text-sm w-[85%] lg:hidden lg:text-base lg:mb-6">
//                         Dominez Tailwind CSS version 4 : apprenez à concevoir des interfaces réactives,
//                     </p>
//                     <button
//                         onClick={handleWatchClick}
//                         className="flex items-center gap-5 lg:px-5 py-2 bg-transparent  rounded hover:bg-[#ffff]/5 transition"
//                     >
//                         <span className="absolute inline-flex h-6 w-6 animate-ping rounded-full bg-blue-600 opacity-75"></span>
//                         <p className="w-6 h-6 bg-blue-600 items-center flex justify-center rounded-full"><IconPlayerPlayFilled size="15" /></p> <p className="text-blue-600 text-lg">Regarder</p>
//                     </button>
//                 </div>
//             </div>
...
//                 <button
//                     onClick={toggleMute}
//                     className="w-10 h-10 rounded-full bg-white/60 backdrop-blur flex items-center justify-center hover:bg-white transition"
//                 >
//                     {isMuted ? <IconVolumeOff className="text-blue-600" /> : <IconVolume className="text-blue-600" />}
//                 </button>
//                 <button
...
//                 </button>
//             </div>
//             <div className="w-full absolute lg:block hidden rounded-b-lg bottom-0 h-36 gadient-videos">
//                 <p className="text-2xl text-white px-10">Nouveautés</p>
//             </div>
//         </div>
//     );
// }
