                    ...
                    <CarouselContent className="lg:p-x4 p-x py-8  ">
                        {cours.map((cours, index) => (
                            <CarouselItem
                                ...
                                <div onClick={() => handleClick(cours.id)} className="lg:w-80 w-[99%] space-y-4 p-4 bg-white hover:bg-primary-foreground shadow border rounded">
