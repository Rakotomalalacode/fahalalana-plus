...
// // 🔄 PUT - Modifier une vidéo existante (remplacer fichiers si fournis)
// export async function PUT(req: NextRequest,  context : { params: Params }) {
...
// // ❌ DELETE - Supprimer une vidéo + fichiers cloudinary
// export async function DELETE(req: NextRequest,  context : { params: Params }) {
//   // const url = new URL(req.url);
//   // const id = Number(url.pathname.split("/").pop());
//   const params = await context.params
...
//   await deleteFromCloudinary(existing.videoPublicId);
//   await deleteFromCloudinary(existing.thumbnailPublicId); // Suppression image aussi
